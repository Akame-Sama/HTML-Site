...
module.exports.run = async (client,message,args) => {
   ...
   .setDescription("**[isimli bota: "+b.username+"#"+b.discrim+" sertifika verildi: Tokyo Code.](https://tokyocode.glitch.me/bot/"+b.botID+"/vote)**")
   ...
   .setColor("#7289da")
   .addField("Server Count", `${b.serverCount ? b.serverCount : "N/A"}`, true)
   .addField("Owner(s)", `<@${b.ownerID}>\n${coowner.replace("<@>", "")}`, true)
   .addField("Links", `[Sunucuna Ekle](https://discord.com/oauth2/authorize?client_id=${b.botID}&scope=bot&permissions=8)${website}${discord}${github}`, true)
   .setFooter("</> with Tokyo Code npm module.");
